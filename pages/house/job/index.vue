<!-- <template>
  List Jobs here create/add jobs, print list of jobs, job creation for on a
  click on create job button, modal form
</template> -->
<template>
  <section class="ml-0 md:ml-64 dark:bg-gray-900 dark:text-gray-100">
    <!-- Filters Section -->
    <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow mb-6">
      <h2 class="text-lg font-semibold mb-4">Jobs You Posted</h2>
      <div
