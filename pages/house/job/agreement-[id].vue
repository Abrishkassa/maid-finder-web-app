<template>
  <section class="py-6 bg-gray-50 dark:bg-gray-900 min-h-screen">
    <div class="container mx-auto px-4 max-w-6xl">
                    ...
                    <div class="flex items-center mt-1">
                      <div class="flex">
                        <Icon
                          ...
                          :class="
                            star <=
                            Math.floor(parseFloat(agreement.maid.rating))
                              ? 'text-yellow-500'
                              : 'text-gray-300 dark:text-gray-600'
                          "
                        />
                    ...
                    <div class="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p class="text-gray-800 dark:text-gray-100">
                          ...
                          <span v-if="agreement.maid.other_language"
                            >, {{ agreement.maid.other_language }}</span
                          >
                        </p>
                      </div>
                    </div>
      ...
      >
        <div
          class="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-4xl w-full p-6 max-h-[90vh] overflow-y-auto"
        >
          <h3
            class="text-lg font-semibold text-gray-800 dark:text-gray-100 flex items-center gap-2 mb-4"
          >
            ...
            <div>
              ...
              <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg space-y-4">
                ...
                <div>
                  ...
                  <div
                    class="px-2.5 py-1.5 rounded-lg bg-gray-100 dark:bg-gray-700"
                  >
                    <span
                      :class="statusClasses(agreement.status)"
