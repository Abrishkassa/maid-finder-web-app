<template>
  <div class="bg-gray-90 min-h-screen">
    ...
    <!-- Hero Section -->
    <div class="max-w-7xl mx-auto px-8 py-12 grid md:grid-cols-2 gap-8 items-center mb-8">
      <!-- Left Content -->
      <div>
      ...
      <div class="flex justify-center">
        <img src="/public/MaidPic.jpg" alt="maid pic" class="max-w-full h-auto" />
      </div>
    </div>
  </div>
  ...
  <div>
    ...
    <section class="py-6 px-8 text-center">
      <div class="flex items-center px-8 mb-8">
        <h2 class="text-2xl font-serif font-semibold bg-lime-400 text-black px-3 py-1 rounded-md">
          Maids
        </h2>
        <p class="font-serif ml-2 align-text-top text-gray-600">Find the perfect helper for your home today!</p>
      </div>
    ...
    <section class="py-6 px-8 text-center">
      <div class="flex items-center px-8 mb-8">
        ...
        <p class="font-serif ml-2 align-text-top text-gray-600">Step by step Guide</p>
      </div>
      ...
      <div class="flex flex-col justify-around mt-4 px-8">
        <div v-for="(step, index) in steps" :key="index"
          ...
          :class="{ 'bg-lime-400 border-blue-500': activeStep === index }" @click="toggleStep(index)">
          <div class="flex items-center justify-between">
            <h3 class="text-xl font-serif  font-bold mb-2">{{ step.title }}</h3>
            <Icon name="ic:baseline-arrow-drop-down" class="w-10 h-10 transition-transform duration-200"
              :class="{ 'rotate-180': activeStep === index }" style="color: black" />
          </div>

          <div v-if="activeStep === index" class="border-t-2 border-black my-2"></div>
          <p v-if="activeStep === index" class="font-serif text-gray-700 text-wrap mt-2">
            {{ step.description }}
          </p>
        </div>
      </div>
    ...
    <div class="container mx-auto px-8">
      ...
      <div class="flex items-center mb-8">
        ...
        <p class="w-96 font-serif ml-2 text-wrap align-text-top text-gray-600">
          At our organization, we offer a range of services to help householders get the helper they need.
        </p>
      </div>

      <!-- Services Grid -->
      <div class="font-serif grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-4">
        ...
        >
          ...
          <div class="flex items-center justify-center gap-2">
            <Icon name="solar:round-arrow-right-up-bold" class="w-6 h-6 text-black mr-2" />
  ...
  <section class="px-12 bg-gray-50">
    <div class="container font-serif  mx-auto border-2 rounded-2xl px-12 py-10 text-left">
      <h2 class="text-3xl font-bold mb-2">Let's make things happen</h2>
      <p class="text-gray-600 text-wrap mb-8 w-96">
        Contact us today to learn more about how our maid-finding services can help you find the perfect helper for your home with ease and confidence.
      </p>
      <a
        href="#"
 ...
 <section class="py-6 px-8 bg-gray-50">
    <div class="container mx-auto px-4">
      <div class="flex items-center mb-8">
        ...
        <p class="w-96 font-serif ml-2 text-wrap align-text-center text-gray-600">
          Meet the skilled and experienced team dedicated to connecting you with the perfect maid for your home needs.
        </p>
      </div>
  ...
  <section class="py-12 bg-gray-50 font-serif">
    <div class="container mx-auto px-4">
      ...
      <!-- Contact Form -->
      <form @submit.prevent="submitForm" class="max-w-2xl justify-left bg-white p-8 rounded-lg shadow-md">
        <!-- Name Input -->
        <div class="mb-6">
...
const services = ref([
  {
    ...
    description: 'Browse through a curated list of verified maids with detailed profiles.',
  },
  {
    icon: 'ic:baseline-search',
    title: 'Advanced Search & Filters',
    description: 'Use advanced search and filters to find the perfect maid for your needs.',
  },
  {
    icon: 'ic:baseline-security',
    title: 'Background Check',
    description: 'Ensure the safety and reliability of your chosen maid with thorough background checks.',
  },
  {
  ...
  },
  {
    ...
    description: 'Get dedicated customer support and assistance whenever you need it.',
  },
  {
