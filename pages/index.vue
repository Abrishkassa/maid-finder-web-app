  ...
  <div>
    <form class="flex flex-col justify-center md:flex-row gap-3">
      <div class="flex">
        ...
        <button type="submit" class="bg-black text-white rounded-r px-2 md:px-3 py-0 md:py-1">
          Search
        </button>
      </div>
    ...
    <section class="py-6 px-8 bg-gray-50">
      <div class="container mx-auto px-8">
        ...
        <div class="font-serif grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-4">
          ...
          <div v-for="(service, index) in services" :key="index" class="bg-white p-6 rounded-lg shadow-md">
      ...
      <div class="container mx-auto px-4">
        <div class="flex justify-between items-center mb-8">
          ...
          <div class="justify-between gap-12">
            <Icon name="mdi:linkedin" style="color: white" class="w-8 h-8 mb-4 text-lime-400" />
            <Icon name="ic:baseline-facebook" style="color: white" class="w-8 h-8 mb-4 text-lime-400" />
            <Icon name="line-md:twitter-x" style="color: white" class="w-8 h-8 mb-4 text-lime-400" />
          </div>
        </div>
        ...
        <div class="flex  gap-24">
          <!-- Contact Us Section -->
          <div>
            <h3 class="text-xl font-semibold bg-lime-400 text-black px-2 py-1 rounded-md mb-4">Contact Us:</h3>
